...
function goBack(){
	document.getElementById("form1").action = "${path}/picmgmt/column/columnAlbumNoSelect.action";
...
function saveAlbum(){
	...
	art.dialog.confirm('您确认该操作吗？', function(){
			var options = {
				url: "${path}/picmgmt/column/saveColumnAlbum.action",
				dataType: 'html',
				beforeSend: function() {
					art.dialog.through({
						id: 'broadcastLoading',
...
<form action="${path}/picmgmt/column/columnAlbumNoSelect.action" method="post" name="form1" id="form1">
