...
function goBack(){
	document.getElementById("form1").action = "${path}/picmgmt/topic/topicAlbumNoSelect.action";
...
<form action="${path}/picmgmt/topic/topicAlbumNoSelect.action" method="post" name="form1" id="form1">
