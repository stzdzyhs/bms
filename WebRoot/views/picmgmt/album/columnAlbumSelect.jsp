...
function deleteSets(id) {
	...
	art.dialog.confirm('你确认删除操作？', function(){
			var options = {
				url: "${path}/picmgmt/column/columnAlbumDelete.action" + param,
				dataType: 'html',
				beforeSend: function() {
					art.dialog.through({
						id: 'broadcastLoading',
...
function goBack(){
	document.getElementById("form1").action = "${path}/picmgmt/column/columnAlbumSelect.action";
...
<form action="${path}/picmgmt/column/columnAlbumSelect.action" method="post" name="form1" id="form1">
<input type="hidden" name="columnId" id="columnId" value="${columnId}" />
  ...
  <div class="toolBar">
    ...
    <!--翻页 end-->
    <div class="operation">
    <input class="btn btn80" type="button" value="新增" onclick="columnAlbumNoSelect('${path}/picmgmt/column/columnAlbumNoSelect.action')">
