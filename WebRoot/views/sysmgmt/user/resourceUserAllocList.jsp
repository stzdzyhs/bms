...
function detail(id,cmdStr){
	art.dialog.open("${path}/sysmgmt/user/userDetail.action?operatorNo=" + id+"&cmdStr="+cmdStr, 
			{
				title: "用户详情", 
				width: 500,
				height: 450,
     ...
     <c:if test="${u.totalSize == -1 }">
       不限制
          ...
          <td class="tdOpera2" align="center">
             <a href="javascript:;" onclick="detail('${u.operatorNo}','${u.resAloc.cmdStr}')">详情</a>
