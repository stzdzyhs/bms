...
$(document).ready(function(){
	ContentWindow.register(null,null,'selectedId','spaceData');
	initWinSelect();
...
function initWinSelect(){
	var json = art.dialog.data('spaceData');
...
<form action="${path}/opermgmt/space/publishSpaceSelect.action" method="post" name="spaceForm" id="spaceForm">
              ...
              <tbody>
                ...
                <td width="90px" height="30">空分组ID：</td>
                  ...
                  <td width="160">
                  	...
                  	onMouseOver="toolTip('空分组名称由中文、大小写英文字母、数字、以及下划线组成')" onMouseOut="toolTip()" 
        ...
        <tr>
          <td align="center">
	          <c:if test="${u.spaceNo != null && u.spaceNo != -1}">
	          	<input type="checkbox" name="selectedId" value="${u.spaceId }" onclick="ContentWindow.updateChannel(this)">
	          </c:if>
          </td>
          ...
          <td align="center">
             ...
             <c:if test="${u.parent != null && space.parentId != -1}">
                  ${u.parent.spaceName }
             </c:if>
          </td>
          <td align="center">
