...
<form action="${path}/opermgmt/company/publishCompanySelect.action" method="post" name="companyForm" id="companyForm">
        ...
        <tr>
          <td align="center">
	          <c:if test="${u.companyNo != null && u.companyNo != -1}">
	          	<input type="checkbox" name="selectedId" value="${u.companyId }" onclick="ContentWindow.updateChannel(this)">
	          </c:if>
          </td>
