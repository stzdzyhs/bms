...
function saveResource(){
	...
	sets.each(function() {
		var id = $(this).val();
		var d = {internetNo:id, internetName: $("#name"+id).text() };
		data.push(d);
	});
...
function detail(regionId){
	art.dialog.open("${path}/opermgmt/internet/cardRegionDetail.action?regionId=" + regionId, 
	{
		title: "智能卡区域详情", 
		width: 450,
		height: 450,
...
<form action="${path}/opermgmt/internet/strategyInternetNoSelect.action" method="post" name="form1" id="form1">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tbody>
        	<tr>
                ...
                <td width="160">
      				<input name="internetName" class="form130px" value="${search.internetName}"  maxlength="50"/>
				</td>
	...
	<table class="tableCommon tableInterlace" width="100%" border="0" cellspacing="0" cellpadding="0">
		<thead>
      	...
      	<tbody>
        	...
        	<tr>
          		<td align="center"><input type="checkbox" name="resourceIds" value="${r.internetNo}">
          		</td>
          		<td align="center" >${r.internetId}</td>
          		<td align="center" id='name${r.internetNo}'>${r.internetName}</td>

          		<td align="center">${r.internetDescribe}</td>
          		<td align="center">${r.createTime}</td>
          		<td class="tdOpera2" align="center">
             		<a href="javascript:;" onclick="detail('${r.internetNo}')">详情</a>
          		</td>
        	</tr>
    		</c:forEach>
		</tbody>
