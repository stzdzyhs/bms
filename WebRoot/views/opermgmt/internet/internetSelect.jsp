              ...
              <tbody>
                ...
                <td width="90px" height="30">网络ID：</td>
                  ...
                  <td width="160">
                  	...
                  	onMouseOver="toolTip('网络名称由中文、大小写英文字母、数字、以及下划线组成')" onMouseOut="toolTip()" />
        ...
        <tr>
          <td align="center">
	          <c:if test="${u.internetNo != null && u.internetNo != -1}">
	          	<input type="checkbox" name="selectedId" value="${u.internetNo }" onclick="ContentWindow.updateChannel(this)">
	          </c:if>
          </td>
