...
$(document).ready(function(){
	ContentWindow.register(null,null,'selectedId','internetData');
	initWinSelect();
...
function initWinSelect(){
	var json = art.dialog.data('internetData');
...
<form action="${path}/opermgmt/internet/publishInternetSelect.action" method="post" name="internetForm" id="internetForm">
        ...
        <tr>
          <td align="center">
	          <c:if test="${u.internetNo != null && u.internetNo != -1}">
	          	<input type="checkbox" name="selectedId" value="${u.internetId }" onclick="ContentWindow.updateChannel(this)">
	          </c:if>
          </td>
          ...
          <td align="center">
             ...
             <c:if test="${u.parent != null && internet.parentId != -1}">
                  ${u.parent.internetName }
             </c:if>
          </td>
          <td align="center">
