...
function saveResource(){
	...
	sets.each(function() {
		var id = $(this).val();
		var d = {clientNo:id, clientName: $("#name"+id).text() };
		data.push(d);
	});
...
function detail(no){
	art.dialog.open("${path}/opermgmt/client/clientDetail.action?clientNo=" + no, 
	{
		title: "用户详情", 
		width: 450,
		height: 450,
...
<form action="${path}/opermgmt/strategy/strategyClientNoSelect.action" method="post" name="form1" id="form1">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tbody>
        	<tr>
                ...
                <td width="160">
      				<input name="clientName" class="form130px" value="${search.clientName}"  maxlength="50"/>
				</td>
	...
	<table class="tableCommon tableInterlace" width="100%" border="0" cellspacing="0" cellpadding="0">
		<thead>
      	...
      	<tbody>
        	...
        	<tr>
          		<td align="center"><input type="checkbox" name="resourceIds" value="${r.clientNo}">
          		</td>
          		<td align="center" >${r.clientId}</td>
          		<td align="center" id='name${r.clientNo}'>${r.clientName}</td>

          		<td align="center">${r.clientDescribe}</td>
          		<td align="center">${r.createTime}</td>
          		<td class="tdOpera2" align="center">
             		<a href="javascript:;" onclick="detail('${r.clientNo}')">详情</a>
          		</td>
        	</tr>
    		</c:forEach>
		</tbody>
