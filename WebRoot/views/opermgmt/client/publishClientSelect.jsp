...
<form action="${path}/opermgmt/client/publishClientSelect.action" method="post" name="clientForm" id="clientForm">
        ...
        <tr>
          <td align="center">
	          <c:if test="${u.clientNo != null && u.clientNo != -1}">
	          	<input type="checkbox" name="selectedId" value="${u.clientId }" onclick="ContentWindow.updateChannel(this)">
	          </c:if>
          </td>
