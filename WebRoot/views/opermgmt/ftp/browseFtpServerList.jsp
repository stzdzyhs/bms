...
<form action="${path}/opermgmt/ftp/browseFtpServerList.action" method="post" name="form1" id="form1">
      ...
      <c:if test="${list == null || fn:length(list) == 0}">
        ...
        <tr>
          ...
          <td class="tdOpera2" align="center">
             <a href="javascript:;" onclick="browseFtpServer('${f.id }','${path}/opermgmt/ftp/selectFtpFileList.action')">浏览</a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
