...
function saveResource(){
	...
	sets.each(function() {
		var id = $(this).val();
		var d = {id:id, regionName: $("#name"+id).text() };
		data.push(d);
	});
...
<form action="${path}/opermgmt/strategy/strategyCardRegionNoSelect.action" method="post" name="form1" id="form1">
  ...
  <div class="tableWrap">
    <table class="tableCommon tableInterlace" width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <c:if test="${list == null || fn:length(list) == 0}">
        ...
        <tr>
          <td align="center"><input type="checkbox" name="resourceIds" value="${r.id}">
          </td>
          <td align="center" id='name${r.id}'>${r.regionName}</td>
          <td align="center">
