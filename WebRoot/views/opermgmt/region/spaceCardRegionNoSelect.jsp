...
function saveCardRegion(){
	...
	art.dialog.confirm('您确认该操作吗？', function(){
			var options = {
				url: "${path}/opermgmt/company/saveCompanyCardRegion.action",
				dataType: 'html',
				beforeSend: function() {
					art.dialog.through({
						id: 'broadcastLoading',
...
function goBack(){
	document.getElementById("form1").action = "${path}/opermgmt/company/companyCardRegionNoSelect.action";
...
<form action="${path}/opermgmt/company/companyCardRegionNoSelect.action" method="post" name="form1" id="form1">
