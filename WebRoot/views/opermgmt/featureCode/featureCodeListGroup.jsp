...
function saveFeatureCode(){
	var feaNos = $("input[name='feaNos']:checked");
	document.getElementById("form1").action = "${path}/opermgmt/strategy/saveFeatureCode.action?feaNos=" + feaNos;
	document.getElementById("form1").submit();
}
</script>
</head>
...
<input type="hidden" name="featureCodeNo" id="featureCodeNo" value="" />
  ...
  <div style="width:100%; text-align:center; margin-top:10px;">
        <input value="保存" type="submit" class="btnQuery" onClick="saveFeatureCode()"/>
          &nbsp;&nbsp;
